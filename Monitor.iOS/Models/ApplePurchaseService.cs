...
namespace Monitor.iOS.Models
{
    public class ApplePurchaseService :PurchaseService
    {
        private readonly ObserverDelegate _observerDelegate = new ObserverDelegate();

        public ApplePurchaseService()
        {
            SKPaymentQueue.DefaultQueue.AddTransactionObserver(_observerDelegate);
        }
    ...
    public class RequestDelegate : SKProductsRequestDelegate
    {
    ...
    internal class ObserverDelegate : SKPaymentTransactionObserver
    {
